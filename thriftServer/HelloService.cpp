...
void HelloServiceClient::hello(std::string& _return, const std::string& username)
{
  send_hello(username);
  recv_hello(_return);
}

void HelloServiceClient::send_hello(const std::string& username)
{
  int32_t cseqid = 0;
...
void HelloServiceClient::recv_hello(std::string& _return)
{
...
void HelloServiceProcessor::process_hello(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->hello(result.success, args.username);
...
void HelloServiceConcurrentClient::hello(std::string& _return, const std::string& username)
{
  int32_t seqid = send_hello(username);
  recv_hello(_return, seqid);
}

int32_t HelloServiceConcurrentClient::send_hello(const std::string& username)
{
...
void HelloServiceConcurrentClient::recv_hello(std::string& _return, const int32_t seqid)
{
